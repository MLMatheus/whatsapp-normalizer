...
addon_info = {
    # add-on Name/identifier, internal for NVDA (must be unique and without spaces)
    "addon_name": "whatsapp-normalizer",
    
    # Add-on summary, usually the user visible name of the addon.
    # Translators: Summary for this add-on
    # to be shown on installation and add-on information found in Add-ons Manager.
    "addon_summary": _("WhatsApp Normalizer"),
    
    # Add-on description
    # Translators: Long description to be shown for this add-on on add-on information from add-ons manager
    "addon_description": _("""Este complemento corrige caracteres Unicode em mensagens do WhatsApp Desktop,
garantindo que sejam exibidas corretamente para o usuários do NVDA."""),
    ...
    "addon_url": "https://github.com/MLMatheus/whatsapp-normalizer",
    
    # URL for the add-on repository where the source code can be found
    "addon_sourceURL": "https://github.com/MLMatheus/whatsapp-normalizer",
